...
HD_PWD='C:/Users/shohei/graphic_display/graphic_display.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pattern.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pattern.tcl -notrace
