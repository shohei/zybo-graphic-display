...
HD_PWD='C:/Users/shohei/graphic_display/graphic_display.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pattern.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pattern.tcl
